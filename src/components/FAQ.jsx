...
const FAQS = [
  ...
  {
    q: "What is the official Telegram channel?",
    a: "Our official Telegram community is TradeX. Always verify you are in the official group to avoid impersonators.",
  },
  {
    ...
    <section id="faq" className="relative py-24 px-4 sm:px-6 lg:px-8 bg-[#020403]">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-3 text-gray-300">Everything you need to know before joining TradeX.</p>
        </div>
