...
export default function GuaranteeSection() {
  const guaranteeSteps = [
    {
      step: "01",
      title: "Join TradeX Telegram",
      desc: "Connect directly to TradeX Telegram to receive live Forex, Gold & Crypto entries with exact TP/SL levels.",
      icon: Lock,
    },
    {
      step: "02",
    ...
    <section id="guarantee" className="relative py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-[#020403] overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-8">
            <div className="max-w-2xl text-left">
              ...
              <p className="mt-2 sm:mt-4 text-sm sm:text-base text-gray-400 leading-relaxed">
                If after 30 days of trading our verified signals from{" "}
                <span className="text-[#00ff66] font-bold">TradeX</span> Telegram you don't see net profit, contact our support for a 100% refund. No questions asked.
              </p>
            </div>
        ...
        <div className="text-center">
          <TelegramButton
            size="lg"
            text="Claim Risk-Free Access on TradeX"
          />
        </div>
