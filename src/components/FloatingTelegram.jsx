...
export default function FloatingTelegram() {
  return (
    <a
      ...
      className="fixed bottom-5 right-4 z-50 flex items-center gap-2 px-4 py-2.5 sm:px-5 sm:py-3 rounded-xl bg-[#00ff66] text-black font-extrabold border-2 border-black hover:scale-105 transition-transform"
    >
